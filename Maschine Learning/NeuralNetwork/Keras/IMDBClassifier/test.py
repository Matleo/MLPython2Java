...
def predictRating(example):
    ...
    if prediction[0][0] - 0.5 > 0:
        print("The given rating is probably--> positive (%f%%)" % (prediction[0][0]*100))
    else:
        print("The given rating is probably--> negative (%f%%)" % (prediction[0][0]*100))
...
exampleNeg = np.array([[125,68 ,2 ,6853 ,15 ,349 ,165 ,4362 ,98 ,5 ,4 ,228,9,43,2,
